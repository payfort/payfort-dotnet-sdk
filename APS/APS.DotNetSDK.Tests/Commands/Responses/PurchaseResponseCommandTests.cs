...
{
    internal class PurchaseResponseCommandTests
    {
        readonly PurchaseResponseCommand _purchaseResponseCommandTest = new();

        [Test]
        public void BuildNotificationCommand_Purchase_ReturnsErrorWhenNoCommand()
        {
            ...
            var actualException = Assert.Throws<InvalidNotification>(() => _purchaseResponseCommandTest.BuildNotificationCommand(responseObjectTest));
            Assert.That(actualException.Message, Is.EqualTo(expectedException));
        }

        [Test]
        public void BuildNotificationCommand_Purchase_ReturnsErrorWhenResponseCommandMismatch()
        {
            IDictionary<string, string> responseObjectTest = new Dictionary<string, string>()
            {
        ...
        [Test]
        public void BuildNotificationCommand_Purchase_ReturnsNoError()
        {
            IDictionary<string, string> responseObjectTest = new Dictionary<string, string>()
            {
            ...
            //act
            //assert
            Assert.DoesNotThrow(() => _purchaseResponseCommandTest.BuildNotificationCommand(responseObjectTest));
        }
    }
}
